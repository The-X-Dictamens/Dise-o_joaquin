// Define la función para desplazarse suavemente a la sección 'specialty'
function scrollToSpecialty() {
    var specialtyDiv = document.getElementById('specialty');
    specialtyDiv.scrollIntoView({ behavior: 'smooth' });
}

// Asigna el evento click al botón "Show More" para activar el desplazamiento
var showMoreBtn = document.getElementById('showMoreBtn');
showMoreBtn.addEventListener('click', scrollToSpecialty);
